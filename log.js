...
container2.addEventListener('submit',(e)=>{
    let checkObjectData={
        mail:checkEmail.value,
        pass:checkEmail.value
    }
    checkArray.push(checkObjectData)
    for (const value of dataArray) {
        for (const value2 of checkArray) {
            if(value2.email==value.mail && value2.pass==value.email)
